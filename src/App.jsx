...
function App() {
  ...
  return (
    <div className="min-h-screen bg-slate-100 flex justify-center w-full font-sans">
      <div className="w-full sm:max-w-[430px] bg-cream shadow-soft h-screen flex flex-col relative overflow-hidden">
        ...
        {!quizPassed ? (
          ...
          <>
            <div key={location.pathname} className="flex-1 overflow-y-auto hide-scrollbar pb-[80px] animate-[pageFadeIn_0.3s_ease-out]">
